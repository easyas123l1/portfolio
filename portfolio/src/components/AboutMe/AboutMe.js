    ...
    return (
        <div className={portfolio.aboutMe}>
            <div className={portfolio.aboutimage}>
                <Navbar />
                <div className={portfolio.aboutpage}>
                    ...
                    <h1 className={portfolio.techstack}>
                        In my free time I enjoy watching sports especially St.
                        Louis Blues Hockey, playing video games with friends,
                    ...
                    <div className={portfolio.techstackDiv}>
                        <a
                            ...
                            href="https://www.linkedin.com/in/andrew-wilson-055b55174/"
                        >
                            <svg
                        ...
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                            href="https://github.com/easyas123l1"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="48"
                    ...
                    <div className={portfolio.techstackDiv}>
                        ...
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                            href="mailto:andrew.wilson90@hotmail.com?Subject=Lets Collaborate"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="48"
